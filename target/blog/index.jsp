<%@ page language="java" isThreadSafe="true" pageEncoding="utf8" import="java.util.*" %>
...
<header class="am-topbar am-topbar-fixed-top">
  <div class="am-container">
    ...
    <div class="am-collapse am-topbar-collapse" id="collapse-head">
      ...
      <div class="am-topbar-right">
        <button class="am-btn am-btn-primary am-topbar-btn am-btn-sm"><span class="am-icon-user"></span> <a href="login.jsp">登录</a></button>
      </div>
    </div>
  </div>
</header>
